...
namespace Shopping.Web.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckOutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id="1", Email="testing@gmail.com", ZipCode="HHHPPP" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("testing@gmail.com", "Forms"), null);
